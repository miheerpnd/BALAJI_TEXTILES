...
$query1 = mysqli_query($mysql,"SELECT sum(net_worth) as a FROM invoice WHERE invoice_type = 'BUY' and date = '$date_1'");
$data1 = mysqli_fetch_assoc($query1);

$query2 = mysqli_query($mysql,"SELECT sum(net_worth) as a FROM invoice WHERE invoice_type = 'BUY' and date = '$date_2'");
$data2 = mysqli_fetch_assoc($query2);

$query3 = mysqli_query($mysql,"SELECT sum(net_worth) as a FROM invoice WHERE invoice_type = 'BUY' and date = '$date_3'");
$data3 = mysqli_fetch_assoc($query3);

$query4 = mysqli_query($mysql,"SELECT sum(net_worth) as a FROM invoice WHERE invoice_type = 'BUY' and date = '$date_4'");
$data4 = mysqli_fetch_assoc($query4);

$query5 = mysqli_query($mysql,"SELECT sum(net_worth) as a FROM invoice WHERE invoice_type = 'BUY' and date = '$date_5'");
